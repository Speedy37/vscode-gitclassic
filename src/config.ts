...
export enum CodeLensCommand {
	...
	CopyRemoteFileUrl = 'gitclassic.copyRemoteFileUrl',
	...
	ShowQuickCommitDetails = 'gitclassic.showQuickCommitDetails',
	ShowQuickCommitFileDetails = 'gitclassic.showQuickCommitFileDetails',
