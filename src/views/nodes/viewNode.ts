...
export enum ContextValues {
	ActiveFileHistory = 'gitclassic:history:active:file',
	ActiveLineHistory = 'gitclassic:history:active:line',
	Branch = 'gitclassic:branch',
	Branches = 'gitclassic:branches',
	BranchStatusAheadOfUpstream = 'gitclassic:status-branch:upstream:ahead',
	BranchStatusBehindUpstream = 'gitclassic:status-branch:upstream:behind',
	BranchStatusNoUpstream = 'gitclassic:status-branch:upstream:none',
	BranchStatusSameAsUpstream = 'gitclassic:status-branch:upstream:same',
	BranchStatusFiles = 'gitclassic:status-branch:files',
	Commit = 'gitclassic:commit',
	Commits = 'gitclassic:commits',
	Compare = 'gitclassic:compare',
	CompareBranch = 'gitclassic:compare:branch',
	ComparePicker = 'gitclassic:compare:picker',
	ComparePickerWithRef = 'gitclassic:compare:picker:ref',
	CompareResults = 'gitclassic:compare:results',
	CompareResultsCommits = 'gitclassic:compare:results:commits',
	Contributor = 'gitclassic:contributor',
	Contributors = 'gitclassic:contributors',
	DateMarker = 'gitclassic:date-marker',
	File = 'gitclassic:file',
	FileHistory = 'gitclassic:history:file',
	Folder = 'gitclassic:folder',
	LineHistory = 'gitclassic:history:line',
	Merge = 'gitclassic:merge',
	MergeConflictCurrentChanges = 'gitclassic:merge-conflict:current',
	MergeConflictIncomingChanges = 'gitclassic:merge-conflict:incoming',
	Message = 'gitclassic:message',
	Pager = 'gitclassic:pager',
	PullRequest = 'gitclassic:pullrequest',
	Rebase = 'gitclassic:rebase',
	Reflog = 'gitclassic:reflog',
	ReflogRecord = 'gitclassic:reflog-record',
	Remote = 'gitclassic:remote',
	Remotes = 'gitclassic:remotes',
	Repositories = 'gitclassic:repositories',
	Repository = 'gitclassic:repository',
	RepositoryFolder = 'gitclassic:repo-folder',
	ResultsFile = 'gitclassic:file:results',
	ResultsFiles = 'gitclassic:results:files',
	SearchAndCompare = 'gitclassic:searchAndCompare',
	SearchResults = 'gitclassic:search:results',
	SearchResultsCommits = 'gitclassic:search:results:commits',
	Stash = 'gitclassic:stash',
	Stashes = 'gitclassic:stashes',
	StatusFileCommits = 'gitclassic:status:file:commits',
	StatusFiles = 'gitclassic:status:files',
	StatusAheadOfUpstream = 'gitclassic:status:upstream:ahead',
	StatusBehindUpstream = 'gitclassic:status:upstream:behind',
	StatusNoUpstream = 'gitclassic:status:upstream:none',
	StatusSameAsUpstream = 'gitclassic:status:upstream:same',
	Tag = 'gitclassic:tag',
	Tags = 'gitclassic:tags',
}
